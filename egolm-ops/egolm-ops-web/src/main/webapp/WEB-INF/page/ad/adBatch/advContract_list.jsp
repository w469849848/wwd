...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="delete" href="<%=request.getContextPath() %>/api/advContract/delete?id={sid_user}"  target="ajaxTodo" title="广告位删除后,对应的广告也会同步删除,是否继续?" warn=""><span>删除</span></a></li>
			<li><a class="edit" href="<%=request.getContextPath() %>/api/advContract/loadMsgByID?id={sid_user}" target="navTab" rel="page1" title="编辑广告位" fresh="false"><span>编辑</span></a></li>
