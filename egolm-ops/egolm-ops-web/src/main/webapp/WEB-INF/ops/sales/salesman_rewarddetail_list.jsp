...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/egolm/assets/css/salesman-manage.css" />
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="audit table-box border-radius"> <!-- 审核表 -->
						 <form action="toSalesRewardDetailList" id="limitPageForm">
							...
							<table class="footable table even" data-page-size="10">
								<thead class="bg-color">
									<tr>
										...
										<th data-hide="">业务员编号</th>
										<th data-hide="">业务员姓名</th>
										<th data-hide="">提成方式</th>
										<th data-hide="phone">提成比例</th>
										<th data-hide="phone,tablet">总业务额</th>
										<th data-hide="phone">提成金额</th>
								...
								<tbody>
									<c:forEach items="${datas.DataList}" var="d">
										<tr>
											...
											<td>${d.nTotalBizAmount}</td>
											<td>${d.nCommissionAmount}</td>
