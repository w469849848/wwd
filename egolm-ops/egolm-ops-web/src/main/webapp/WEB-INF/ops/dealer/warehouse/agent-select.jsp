...
<script src="${egolmHost}${serverName}/resources/js/dealer/warehouse/agent-select.js"></script>
	...
	<div class="page-content">
		...
		<div class=" table-box">
			<div class="filter-wrap clearfix"> 
						...
						<input 	class="filter border-radius bg-color" placeholder="经销商名称"	name="sAgentName" id="sAgentName"  id="filter" type="text" />
					</label> 
			...
			<table class="footable table even" data-page-size="5" id="listTable">
				<thead class="bg-color">
					<tr>
						...
						<th data-toggle="phone,tablet">经销商抬头</th>
