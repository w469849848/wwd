...
<script src="${egolmHost}${serverName}/resources/js/dealer/warehouse/district-select.js"></script>
	...
	<div class="page-content">
		...
		<div class=" table-box">
			<div class="filter-wrap clearfix"> 
				 	<input type="hidden" name="sCityID" id="sCityID"  value= "${sCityID }" /> 
				 	<input type="hidden" name="districtIDs" id="districtIDs"  value= "${districtIDs }" /> 
						<label class="">
						<i class="icon-search f-95"></i>
						<input 	class="filter border-radius bg-color" placeholder="地区名称"	name="sRegionDesc" id="sRegionDesc"  id="filter" type="text" />
					</label> 
			...
			<table class="footable table even" data-page-size="5" id="listTable">
				<thead class="bg-color">
					<tr>
						<th></th>
						<th data-toggle="true">编码</th>
						<th data-toggle="true">名称</th>
						<th data-toggle="true">类型</th>
						<th data-hide="phone">状态</th>
					</tr>
				</thead>
				<tbody id="select_msg_id">
				</tbody>
				<tfoot>
					<tr>
						<td colspan="10" class="clearfix">
							<div class="batch">
								...
								<label><input class="border border-radius bg-color f-50" type="button" value="确定" onClick="bindClicked();"/></label>
							</div>
						</td>
					</tr>
				</tfoot>
