...
<script src="${egolmHost}${serverName}/resources/js/goods/price/shop-select.js"></script>
	...
	<div class="page-content">
		...
		<div class=" table-box">
			<div class="filter-wrap clearfix"> 
				 	<input type="hidden" name="sShopNO" id="sShopNO"  value= "${sShopNO }" /> 
				 	<input type="hidden" name="constractNO" id="constractNO"  value= "${constractNO }" /> 
						<label class="">
						<i class="icon-search f-95"></i>
						<input 	class="filter border-radius bg-color" placeholder="店铺名称"	name="sShopName" id="sShopName"  id="filter" type="text" />
					</label> 
