...
var addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea)
{
	...
	function changeProvince()
	{
		...
		for(var i=0; i<item.children.length; i++)
		{
			//item.children[i].name 改  item.children[i]
			cmbAddOption(cmbCity, item.children[i], item.children[i]);
		}
	...
	{
		//provinceList[i].name 改 provinceList[i]
		cmbAddOption(cmbProvince, provinceList[i], provinceList[i]);
	}
