...
<form id="pagerForm" method="post" action="<%=request.getContextPath() %>/api/adVert/list?selectType=audit">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<%=request.getContextPath() %>/api/adVert/list?selectType=audit" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="<%=request.getContextPath() %>/api/adVert/updateTywAdVertNTag?id={sid_user}&nTag=2" target="ajaxTodo" title="" warn=""><span>审核通过</span></a></li>
			<li><a class="add" href="<%=request.getContextPath() %>/api/adVert/updateTywAdVertNTag?id={sid_user}&nTag=3" target="ajaxTodo" title="" warn=""><span>审核不通过</span></a></li>
