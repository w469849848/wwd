...
<html lang="en">
	<head>
		...
		<!-- salesman style -->
		<link rel="stylesheet" href="${opsPath}/resources/assets/css/add-tpl.css" />
	...
	<body>
					...
					<div class="page-content">
						...
						<div class="wh_titer">
							<p class="wh_titer_f">
								...
								<a class="active" href="add-tpl.html">修改模板</a>
							</p>
						</div>
							...
							<form>
								<p class="row">
									<small class="col-xs-10 col-sm-10 col-md-7 col-lg-6">
										<span class="col-xs-4 col-sm-2">标题：</span>
								...
								<p class="row">
									<small class="col-xs-10 col-sm-10 col-md-7 col-lg-6">
										<span class="col-xs-4 col-sm-2">描述：</span>
										<label class="col-xs-7 col-sm-9">
											<input class="border border-radius bg-color" type="text" />
										</label>
									</small>
									...
									<div class="col-xs-10 col-sm-10 col-md-7 col-lg-6">
										<div class="col-xs-12 col-sm-6 mr">
											...
											<div class="col-xs-7 dropdown-wrap">
												<a id="salesman-type" class="dropdown-btn border border-radius bg-color dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">
										          	<span>苏州</span>
										          	<span class="dr"><img src="${opsPath}/resources/assets/images/arrow-black.png"/></span>
										        </a>
										        <ul id="salesman-menu" class="dropdown-menu" aria-labelledby="salesman-type">
										          	<li>苏州</li>
										          	<li>苏州</li>
										          	<li>分销</li>
										        </ul>
								...
								<div class="module-wrap">
									...
									<div class="row tit">
										<a class="detail" href="javascript:void(0)">添加模块</a>
										<span class="orange">备注：拖动模块可以调整模块显示顺序</span>
									</div>
									...
									<p class="row module">
										<small class="col-xs-10 col-sm-10 col-md-7 col-lg-6">
											<label class="col-xs-11 col-sm-11">
												<input class="border border-radius bg-color" value="导航模板" type="text" />
											</label>
										</small>
									</p>
									...
									<p class="row module">
										<small class="col-xs-10 col-sm-10 col-md-7 col-lg-6">
											<label class="col-xs-11 col-sm-11">
												<input class="border border-radius bg-color" value="热卖商品模块" type="text" />
											</label>
										</small>
									</p>
									...
									<p class="row module">
										<small class="col-xs-10 col-sm-10 col-md-7 col-lg-6">
											<label class="col-xs-11 col-sm-11">
												<input class="border border-radius bg-color" value="推荐品牌模块" type="text" />
											</label>
										</small>
									</p>
									...
									<p class="row module">
										<small class="col-xs-10 col-sm-10 col-md-7 col-lg-6">
											<label class="col-xs-11 col-sm-11">
												<input class="border border-radius bg-color" value="商品楼层模块" type="text" />
											</label>
										</small>
									</p>
									...
									<p class="row module">
										<small class="col-xs-10 col-sm-10 col-md-7 col-lg-6">
											<label class="col-xs-11 col-sm-11">
												<input class="border border-radius bg-color" value="猜你喜欢" type="text" />
											</label>
										</small>
									</p>
								</div>
								...
								<p class="row">
									<small class="col-xs-10 col-sm-10 col-md-7 col-lg-6">
										...
										<label class="col-xs-7 col-sm-9">
											...
											<input class="cancel border-radius border col-xs-6 col-sm-3 col-md-3" type="button" value="取消" />
										</label>
									</small>
								</p>
							</form>
		...
		<!--新增模板-->
		<script src="${opsPath}/resources/assets/js/add-tpl.js"></script>
</body>
</html>