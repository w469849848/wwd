...
<e:point id="content" parentPath="/WEB-INF/common/htmlBase.jsp" currentPath="/WEB-INF/ops/promo/promo-bw-list.jsp">
		...
		<div class="page-content">
			<div class="wh_titer">
				<p class="wh_titer_f">
					...
					&gt;
					<a class="active" href="">名单管理</a>
				</p>
			</div>

			<div class="goods table-box">
				<!-- 模板列表 -->
				<form action="bwList?promo.sPromoPaperNO=${promo.sPromoPaperNO}" id="limitPageForm" method="post">
					...
					<tbody>
						<c:forEach items="${datas}" var="data">
							<tr>
								...
								<td>
									<a href="javascript:AjaxToDelBWList('${promo.sPromoPaperNO}', '${data.sShopNO}');">删除</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
					<tfoot>
						<tr>
							<td colspan="13" class="clearfix">
								<div class="batch">
									<label>
										<input class="border border-radius bg-color f-50" type="button" onclick="javascript:window.location.href='bwSelect?promo.sPromoPaperNO=${promo.sPromoPaperNO}'" value="添加商铺" />
									</label>
								</div>
