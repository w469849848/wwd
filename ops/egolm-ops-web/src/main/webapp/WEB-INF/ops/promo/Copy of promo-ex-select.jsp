...
<e:point id="content" parentPath="/WEB-INF/common/htmlBase.jsp" currentPath="/WEB-INF/ops/promo/promo-ex-select.jsp">
		...
		<div class="page-content">
			<div class="wh_titer">
				<p class="wh_titer_f">
					...
					&gt;
					<a href="${webHost}/promotion/exList?promoDtl.sPromoPaperNO=${promo.sPromoPaperNO}&promoDtl.nTag=2">排除商品</a>
					&gt;
					<a class="active" href="">选择排除商品</a>
				</p>
			</div>

			<div class="goods table-box">
				<!-- 模板列表 -->
				<form action="exSelect?promo.sPromoPaperNO=${promo.sPromoPaperNO}" id="limitPageForm" method="post">
					...
					<tbody>
						<c:forEach items="${datas}" var="data">
							<tr>
								...
								<td style="width:130px;"><a href="javascript:void(0);" onclick="PromoAddExGoods('${promo.sPromoPaperNO}', '${promo.sAgentContractNO}', '${data.nGoodsID}');">添加到排除商品列表</a></td>
							</tr>
						</c:forEach>
					</tbody>
					<tfoot>
