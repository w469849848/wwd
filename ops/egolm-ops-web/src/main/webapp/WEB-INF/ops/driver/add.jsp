		...
		<div class="page-content">
			<div class="wh_titer">
				<p class="wh_titer_f">
					...
					<a class="active" href="${webHost}/logistics/driver/addDriver">新增司机</a> 
				</p>
			</div>
			<div class="add-box">
				<form id="create-driver-form">
					<p class="row">
						<small class="col-xs-12 col-sm-12 col-md-9 col-lg-7"> 
							...
							<label class="col-xs-7 col-sm-9">
								<input name="sDrivemanNo" class="border border-radius bg-color" type="text" />
							</label>
						</small>
					</p>
					<p class="row">
						<small class="col-xs-12 col-sm-12 col-md-9 col-lg-7">
							...
							<label class="col-xs-7 col-sm-9">
								<input name="sDrivemanName" class="border border-radius bg-color" type="text" />
							</label>
						</small>
					</p>
					<p class="row">
						<small class="col-xs-12 col-sm-12 col-md-9 col-lg-7">
							...
							<label class="col-xs-7 col-sm-9">
								<input name="sDrivemanPwd" class="border border-radius bg-color" type="text" />
							</label>
						</small>
					</p>
					<p class="row">
						...
						<span class="col-xs-4 col-sm-2"><font color="red">*</font>联系方式：</span>
							<label class="col-xs-7 col-sm-9">
								<input name="sTel" class="border border-radius bg-color" type="text" />
							</label>
						</small>
					</p>
					<div class="row">
							...
							<div class="col-xs-12 col-sm-6 mr">
								...
								<div class="col-xs-7 dropdown-wrap">
									<a class="dropdown-btn border border-radius bg-color dropdown-toggle adapt-list" 
								   		href="javascript:void(0)" data-toggle="dropdown" role="button"
								   		aria-haspopup="true" aria-expanded="true">
								   		<span class="item-name" id="current-agent">请选择</span>
								   		<input type="hidden" name="nAgentID" id="nAgentID"/>
							...
							<div class="col-xs-12 col-sm-6 mr">
								...
								<div class="col-xs-7 dropdown-wrap">
									<a class="dropdown-btn border border-radius bg-color dropdown-toggle adapt-list" 
								   		href="javascript:void(0)" data-toggle="dropdown" role="button"
								   		aria-haspopup="true" aria-expanded="true">
								   		<span class="item-name" id="current-ware-house">请选择</span>
									    <input type="hidden" name="sWareHouseNo" id="sWareHouseNo"/>
									    <input type="hidden" name="sWarehouseName" id="sWarehouseName"/>
								   		<span class="dr"><img src="${resourceHost}/images/arrow-black.png" /></span>
									</a>
					...
					<p class="row">
						...
						<label class="col-xs-7 col-sm-9">
						<textarea name="sMemo" class="border border-radius bg-color" rows="4"></textarea>
						</label>
						</small>
					</p>
					<p class="row">
						...
						<label class="col-xs-7 col-sm-9">
						<input id="submit-create-driver" class="border-radius border col-xs-6 col-sm-3 col-md-3" type="button" value="保存" />
