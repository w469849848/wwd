...
<e:resource title="业务员管理"  currentTopMenu="业务员管理" currentSubMenu="线路管理" css="css/salesman-manage.css"   js="js/common.js"  localCss="" localJs="salesman/line_list.js" />
<e:point id="content" parentPath="/WEB-INF/common/htmlBase.jsp" currentPath="/WEB-INF/ops/sales/line_list.jsp">
					...
					<div class="page-content">
						<div class="wh_titer">
							<p class="wh_titer_f">您的位置：
								...
								<a class="active" href="lineList">路线管理</a>
							</p>
						</div>
					<div class="audit table-box border-radius"> <!-- 审核表 -->
						<form action="lineList" id="limitPageForm">
							...
							<div class="filter-wrap">
								<label class="">
									...
									<input class="filter border-radius bg-color"  width="60px" placeholder="线路编号/线路名称" id="sSalParam" name="sSalParam" type="text" />
								</label>
								<%-- <label class="">
								...
								<lable>
									<span class="pull-right">
											<a class="add-man"  href="${webHost}/salesman/line/create"><i class="add-icon"></i>新增路线</a>
											<a class="add-man" onclick='$("#limitPageForm").submit()'>查询<span></span></a>
									</span>
								</lable>
							</div>
							</form>
							<table class="footable table even" data-page-size="10">
								<thead class="bg-color">
									<tr>
										<th></th>
										<th data-toggle="true">路线名称</th>
										<th data-hide="phone">店鋪名称</th>
								...
								<tbody>
									<c:forEach items="${datas.DataList}" var="d">
										<tr>
											...
											<td>${d.sRemark}</td>
											<td>
												<a class="edit"  href="toEditLine?sLineId=${d.sLineId}&type=edit"><img src="${pageContext.request.contextPath}/resources/egolm/assets/images/edit.png" alt="编辑" /></a>
												<a class="delete" pid="${d.sLineId}" href="javascript:void(0)" ><img src="${pageContext.request.contextPath}/resources/egolm/assets/images/delete.png" alt="删除" /></a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
